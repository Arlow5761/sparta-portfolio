...
export function SectionThumbnails() {
    ...
    return (
        <div className="flex flex-row overflow-clip h-full w-full justify-center items-center gap-[6vw] landscape:flex-col landscape:gap-[10vh]">
            <div className="material-symbols-outlined text-center content-center text-[20vh] min-h-[20vh] min-w-[20vh] landscape:min-h-[20vw] landscape:min-w-[20vw] landscape:text-[20vw]">
                {icon}
            </div>
        </div>
    );
